...
/** Overview — four panes, one per thing the page summarises. */
...
/** Clipboard with a checklist — the people-directed Tasks board. */
...
export const ChevronDownIcon = ({ open }: { open?: boolean }) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`admin-panel__picker-chevron${open ? " admin-panel__picker-chevron--open" : ""}`}
  >
    <path d="M6 9l6 6 6-6" />
  </svg>
);
