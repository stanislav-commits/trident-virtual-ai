...
export class ChatSemanticRouterService {
  ...
  private buildSystemPrompt(): string {
    return [
      ...
      '- PMS/current maintenance record asks are historical_case with historical_procedure: due or overdue work, upcoming tasks, next service, current status, current equipment hours, responsible person, performed by, approved by, work scope, task references, planned or completed maintenance, breakdown events, corrective events, and engineer notes.',
